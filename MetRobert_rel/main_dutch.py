...
from MetRobert_rel.utils import Config, Logger, make_log_dir
from MetRobert_rel.modeling import (
...
from MetRobert_rel.run_classifier_dataset_utils import processors, output_modes, compute_metrics
from MetRobert_rel.data_loader import load_train_data, load_test_data, load_dev_data, load_train_data_kf
...
def main(dev_dir):
    ...
    #config = Config(main_conf_path="/vol/tensusers4/jgrunwald/metaphorclam/metaphorclam/MetRobert_rel/")
    current_dir = os.path.dirname(os.path.realpath(__file__))
    config = Config(main_conf_path=current_dir)
